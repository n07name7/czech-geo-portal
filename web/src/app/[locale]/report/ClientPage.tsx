...
export default function ReportPage() {
  ...
  const select = (r: GeocodeResult) => {
    ...
    params.set("lon", String(r.lon));
    params.set("address", r.label);
              ...
              {loading && (
                <div className="flex flex-col gap-6 py-8 animate-pulse">
                  <div className="flex justify-between items-end mb-4">
                    ...
                    <div className="h-12 w-24 bg-[var(--border)] rounded-full" />
                  </div>
                  <div className="h-64 w-full bg-[var(--border)] rounded-xl" />
                  ...
                  <div className="flex items-start justify-between mb-6 gap-4">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        btn.innerHTML = `✓ ${t("report.copied")}`;
                        setTimeout(() => { btn.innerHTML = oldText; }, 2000);
                      }}
                      className="shrink-0 border border-[var(--border)] bg-[var(--surface)] px-3 py-1.5 text-xs font-body text-[var(--text-muted)] hover:text-[var(--text)] hover:border-[var(--accent)] transition-colors"
                    >
                      🔗 {t("report.copyLink")}
                    </button>
                  </div>
