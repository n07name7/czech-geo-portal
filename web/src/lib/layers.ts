...
const R2_BASE = (process.env.NEXT_PUBLIC_R2_BASE_URL || "/api/pmtiles").replace(/\/$/, "");
...
export const LAYERS: LayerConfig[] = [
  ...
  { id: "highschool",    labelKey: "layers.highschool",    pmtilesUrl: `${R2_BASE}/highschool.pmtiles` },
  { id: "air",           labelKey: "layers.air",           pmtilesUrl: `${R2_BASE}/air.pmtiles` },
];
